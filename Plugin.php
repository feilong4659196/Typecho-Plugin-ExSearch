...
?>
<link rel="stylesheet" href="<?php Helper::options()->pluginUrl('ExSearch/assets/ExSearch-3b07d0e077.css'); ?>">
<!--插件配置-->
<script>
ExSearchConfig = {
    root : "",
...
?>
<script src="<?php Helper::options()->pluginUrl('ExSearch/assets/ExSearch-36c0b0ab85.js'); ?>"></script>
<?php
    }
}